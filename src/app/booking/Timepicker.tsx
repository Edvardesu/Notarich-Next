  ...
  return (
    <div className="flex flex-col items-center p-4">
        ...
        <div className="overflow-auto h-32 w-20 hide-scrollbar">
          {hoursArray.map((hour) => (
            <div key={hour} 
                 ...
                 className={`cursor-pointer p-2 text-center ${selectedHour === hour ? 'bg-gray-200' : ''}`}>
              {hour}
            </div>
          ))}
        </div>
        ...
        <div className="overflow-auto h-32 w-20 hide-scrollbar">
          {minutesArray.map((minute) => (
            <div key={minute} 
                 ...
                 className={`cursor-pointer p-2 text-center ${selectedMinute === minute ? 'bg-gray-200' : ''}`}>
              {minute}
            </div>
          ))}
        </div>
        ...
        <div className="overflow-auto h-32 w-20 hide-scrollbar">
          {secondsArray.map((second) => (
            <div key={second} 
                 ...
                 className={`cursor-pointer p-2 text-center ${selectedSecond === second ? 'bg-gray-200' : ''}`}>
              {second}
            </div>
          ))}
        </div>
      ...
      <button 
        ...
        onClick={() => onTimeSelected(`${selectedHour}:${selectedMinute}:${selectedSecond}`)}>
        Set Time
      </button>
    </div>
  );
